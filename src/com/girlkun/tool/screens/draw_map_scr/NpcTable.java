...
public class NpcTable extends JFrame {
   ...
   public NpcTable(DrawMapScr drawMapScr) {
      ...
      this.setTitle("Girlkun75 - Npc template");
   }
   ...
   private void initComponents() {
      ...
      this.tbl1.addMouseListener(new MouseAdapter() {
         ...
         public void mouseClicked(MouseEvent evt) {
            NpcTable.this.tbl1MouseClicked(evt);
         }
      });
      this.tbl1.addKeyListener(new KeyAdapter() {
         @Override
         public void keyPressed(KeyEvent evt) {
            NpcTable.this.tbl1KeyPressed(evt);
         }

         @Override
         public void keyReleased(KeyEvent evt) {
            NpcTable.this.tbl1KeyReleased(evt);
         }
      });
   ...
   private void tbl1MouseClicked(MouseEvent evt) {
      ...
      if (index != -1) {
         this.drawMapScr.setNpcTemplateChoose(Manager.gI().getNpcTemplates().get(index));
      }
   }
   ...
   private void fillToTable() {
      ...
      for (NpcTemplate npc : Manager.gI().getNpcTemplates()) {
         this.model1.addRow(new Object[]{npc.getId(), npc.getName(), npc.getAvatar()});
      }
   }
   ...
   private void setup() {
      ...
      this.model1 = new DefaultTableModel(new String[]{"ID", "Name", "Avatar"}, 0) {
         @Override
      ...
      this.tbl1.getColumnModel().getColumn(2).setCellRenderer(new NpcTable.ImageRender());
      this.fillToTable();
   }
   ...
   public static void main(String[] args) {
      try {
         ...
         Logger.getLogger(NpcTable.class.getName()).log(Level.SEVERE, null, var5);
      } catch (InstantiationException var6) {
         Logger.getLogger(NpcTable.class.getName()).log(Level.SEVERE, null, var6);
      } catch (IllegalAccessException var7) {
         Logger.getLogger(NpcTable.class.getName()).log(Level.SEVERE, null, var7);
      } catch (UnsupportedLookAndFeelException var8) {
         Logger.getLogger(NpcTable.class.getName()).log(Level.SEVERE, null, var8);
      }

      EventQueue.invokeLater(new Runnable() {
         @Override
         public void run() {
            new NpcTable(null).setVisible(true);
         }
      });
   }
